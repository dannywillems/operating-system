...
pub fn create_router(state: AppState) -> Router {
    let api_routes = Router::new()
        ...
        .route("/auth/tokens/:token_id", delete(handlers::auth::revoke_api_token))
        // Board routes
        ...
        .route("/boards/:board_id/permissions", post(handlers::boards::add_permission))
        .route("/boards/:board_id/permissions/:user_id", delete(handlers::boards::remove_permission))
        // Column routes
        ...
        .route("/columns/:column_id", delete(handlers::columns::delete_column))
        .route("/columns/:column_id/move", patch(handlers::columns::move_column))
        // Card routes
    ...
    let web_routes = Router::new()
        ...
        .route("/boards/:board_id/settings", get(handlers::web::board_settings))
        .route("/boards/:board_id/columns/new", post(handlers::web::create_column_submit))
        .route("/boards/:board_id/cards/new", post(handlers::web::create_card_submit))
        .route("/cards/:card_id/move", post(handlers::web::move_card_submit));
