// Global chat interface for cross-board management via LLM
(function() {
    'use strict';
    ...
    // Don't initialize global chat on board detail pages (they have their own chat)
    ...
    const chatToggle = document.getElementById('global-chat-toggle');
    const CHAT_STATE_KEY = 'global-chat-expanded';
    ...
    chatForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            // If actions were taken that modified boards, refresh after a delay
